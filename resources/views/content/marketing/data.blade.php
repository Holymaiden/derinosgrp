...
<tr>
        ...
        <!--begin::Nama=-->
        <td>
                <div class="text-gray-800 text-hover-primary">{{ $v['nama'] }}</div>
        </td>
        <!--end::Nama=-->
        <!--begin::Action=-->
        <td class="text-end">
                <a href="javascript:void(0)" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="modal" data-bs-target="#kt_modal_add_marketing" data-id="update-{{ $v['id'] }}">
