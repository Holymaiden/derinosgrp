...
<script src="{{ asset('assets/js/master/perumahan/table.js') }}"></script>
<script src="{{ asset('assets/js/master/perumahan/export.js') }}"></script>
...
<script src="{{ asset('assets/js/master/perumahan/perumahan-crud.js') }}"></script>
@endpush
    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Perumahan List</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Perumahan Management</li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-400 w-5px h-2px"></span>
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Perumahan</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search perumahan" id="kt_table_search" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <!--end::Filter-->
                            <!--begin::Export-->
                            {{-- <a href="{{ route('perumahan-list.export') }}"> --}}
                                {{-- <button type="button" class="btn btn-light-primary me-3" id="btn-export"> --}}
                                <button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_export_perumahans">
                            ...
                            <!--end::Export-->
                            <!--begin::Add perumahan-->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_perumahan" data-id="create-0">
                                ...
                                <!--end::Svg Icon-->Add Perumahan</button>
                            <!--end::Add perumahan-->
                        </div>
                        <!--end::Toolbar-->
                        <!--begin::Group actions-->
