                ...
                <form id="form-create-edit" class="form" action="POST">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Select-->
                            <select name="status" id="input-status" class="form-select form-select-solid"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Select-->
                            <select name="customer" id="input-customer" class="form-select form-select-solid"
                                data-control="select2" data-placeholder="Select option" data-allow-clear="true"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Select-->
                            <select name="marketing" id="input-marketing" class="form-select form-select-solid"
                                data-control="select2" data-placeholder="Select option" data-allow-clear="true"
                                data-dropdown-parent="#kt_modal_show">
                            </select>
                            <!--end::Select-->
