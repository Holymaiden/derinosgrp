...
<svg id="ket_cavling" xmlns="http://www.w3.org/2000/svg" width="800" height="200">
    ...
    <!-- Text -->
    <text x="10" y="40" font-family="Arial" font-size="18" fill="black" font-weight="bold">Keterangan :</text>
    ...
    <rect x="110" y="60" width="30" height="30" fill="rgb(0, 158, 247)" />
    <text x="150" y="85" font-family="Arial" font-size="14" fill="black">Rencana</text>

    <rect x="210" y="60" width="30" height="30" fill="rgb(255, 199, 0)" />
    <text x="250" y="85" font-family="Arial" font-size="14" fill="black">Progres</text>

    <rect x="350" y="60" width="30" height="30" fill="rgb(241, 65, 108)" />
    <text x="390" y="85" font-family="Arial" font-size="14" fill="black">Terlambat</text>

    <rect x="480" y="60" width="30" height="30" fill="rgb(80, 205, 137)" />
    <text x="520" y="85" font-family="Arial" font-size="14" fill="black">Selesai</text>
</svg>
