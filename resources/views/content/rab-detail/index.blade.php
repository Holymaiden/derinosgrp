...
@push('javascript-custom')
    <script src="{{ asset('assets/js/master/rab-detail/table.js') }}"></script>
    <script src="{{ asset('assets/js/master/rab-detail/export.js') }}"></script>
    ...
    <script src="{{ asset('assets/js/master/rab-detail/rab-detail-crud.js') }}"></script>
@endpush
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-user-table-filter="search"
                                    ...
                                    placeholder="Search nama atau total" id="kt_table_search" />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end gap-2" data-kt-user-table-toolbar="base">
                                <a onclick="exportRab('{{ route('rab-detail-list.export') }}','{{ $id }}')">
                                ...
                                {{-- <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#kt_modal_add_perumahan" data-id="create-0">
                                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                                    <span class="svg-icon svg-icon-2">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                            ...
                            @include('content.rab-detail.modal-export')
                            <!--end::Modal - New Card-->
                            <!--begin::Modal - Add task-->
                            @include('content.rab-detail.modal-create-edit')
                            <!--end::Modal - Add task-->
                        </div>
                        <!--end::Card toolbar-->
                    </div>
