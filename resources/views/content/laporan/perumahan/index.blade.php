                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <a href="{{ route('laporan.perumahan-list.export') }}">
                                    <button type="button" class="btn btn-primary" id="btn-export">
                                        ...
                                        <!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/kt-products/docs/craft/html/releases/2023-07-21-074920/core/html/src/media/icons/duotune/general/gen005.svg-->
