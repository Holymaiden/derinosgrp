...
<script src="{{ asset('assets/js/laporan/marketing/table.js') }}"></script>
<script src="{{ asset('assets/js/laporan/marketing/export.js') }}"></script>
...
<script src="{{ asset('assets/js/laporan/marketing/marketing-crud.js') }}"></script>
@endpush
    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Laporan Marketing List</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Laporan Marketing Management</li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-400 w-5px h-2px"></span>
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Laporan Marketing</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <!--end::Filter-->
                            <!--begin::Export-->
                            {{-- <button type="button" class="btn btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_export_marketings">
                        ...
                        @include('content.laporan.marketing.modal-export')
                        <!--end::Modal - New Card-->
                        <!--begin::Modal - Add task-->
                        @include('content.laporan.marketing.modal-create-edit')
                        <!--end::Modal - Add task-->
                    </div>
                    <!--end::Card toolbar-->
                </div>
