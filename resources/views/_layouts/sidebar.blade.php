<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        ...
        <a href="{{ route('dashboard') }}">
            <img alt="Logo" src="{{ asset('assets/media/logos/default-dark.png') }}" class="h-25px app-sidebar-logo-default" />
            <img alt="Logo" src="{{ asset('assets/media/logos/icon.svg') }}" class="h-20px app-sidebar-logo-minimize" />
        </a>
        <!--end::Logo image-->
    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link @if ($title == 'Dashboard') echo active @endif" href="{{ route('dashboard') }}">
                ...
                <div data-kt-menu="true" class="menu-item menu-accordion">
                    <!--begin:Menu link-->
                    <a class="menu-link @if ($title == 'Users') echo active @endif" href="{{ route('user-management') }}">
                        <span class="menu-icon">
                ...
                <div data-kt-menu="true" class="menu-item menu-accordion">
                    <!--begin:Menu link-->
                    <a class="menu-link @if ($title == 'Marketing') echo active @endif" href="{{ route('marketing-management') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/maps/map002.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div data-kt-menu="true" class="menu-item menu-accordion">
                    <!--begin:Menu link-->
                    <a class="menu-link @if ($title == 'Cavling') echo active @endif" href="{{ route('cavling-management') }}">
                        <span class="menu-icon">
                ...
                <div data-kt-menu="true" class="menu-item menu-accordion">
                    <!--begin:Menu link-->
                    <a class="menu-link @if ($title == 'Customers') echo active @endif" href="{{ route('customer-management') }}">
                        <span class="menu-icon">
                ...
                <div data-kt-menu="true" class="menu-item menu-accordion">
                    <!--begin:Menu link-->
                    <a class="menu-link @if ($title == 'Laporan Perumahan') echo active @endif" href="{{ route('laporan.perumahan-management') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/communication/com013.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div data-kt-menu="true" class="menu-item menu-accordion">
                    <!--begin:Menu link-->
                    <a class="menu-link @if ($title == 'Laporan Marketing') echo active @endif" href="{{ route('laporan.marketing-management') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/communication/com013.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
